...
public class CompactPumpjackContainer extends Container {
    ...
    public CompactPumpjackContainer(int windowId, World world, BlockPos pos, PlayerInventory playerInventory, PlayerEntity player) {
        super(ModContainers.COMPACT_PUMPJACK_CONTAINER.get(), windowId);
 ...
 public boolean isLightningStorm() {
    ...
    public boolean canInteractWith(PlayerEntity playerIn) {
        return isWithinUsableDistance(IWorldPosCallable.of(tileEntity.getWorld(), tileEntity.getPos()),
                playerIn, ModBlocks.COMPACT_PUMPJACK.get());
    }
